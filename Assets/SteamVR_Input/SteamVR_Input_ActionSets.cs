...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_MonsterVR p_MonsterVR;
        ...
        public static SteamVR_Input_ActionSet_MonsterVR MonsterVR
        {
            get
            {
                return SteamVR_Actions.p_MonsterVR.GetCopy<SteamVR_Input_ActionSet_MonsterVR>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_MonsterVR = ((SteamVR_Input_ActionSet_MonsterVR)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_MonsterVR>("/actions/MonsterVR")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.MonsterVR};
        }
    }
}
